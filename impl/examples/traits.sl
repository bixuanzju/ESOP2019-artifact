...
--BEGIN_VERSION_EXT
trait editor2 inherits editor => { version_num = 0.1 };
--END_VERSION_EXT


--BEGIN_RETRIEVE
type Retrieve = { get_version : Top -> Double };
trait retrieve [self : Version] => { get_version (_ : Top) = self.version_num };
--END_RETRIEVE


--BEGIN_RETRIEVE_EXT
type EditorVersion = Editor & Version & Retrieve;
my_editor2 = new[EditorVersion] editor2 & retrieve;
--END_RETRIEVE_EXT
...
--BEGIN_MODAL_OK
editor3 (init_mode : String) = trait [self : ModalEditor] inherits
  editor2 \ {version_num : Double} & retrieve & modal_edit init_mode => {};
--END_MODAL_OK

editor4 (init_mode : String) = trait [self : ModalEditor] inherits
  editor2 \ {version_num : Double} & retrieve &
...
--BEGIN_MODAL_OK3
editor5 (init_mode : String) = trait [self : ModalEditor] inherits
  editor2 \ {version_num : Double} & retrieve & modal_edit init_mode => {
    override version_num = super.version_num + 0.1 };
--END_MODAL_OK3

--BEGIN_MODAL_OK4
editor6 (init_mode : String) = trait [self : ModalEditor] inherits
  editor2 \ {version_num : Double} & retrieve & modal_edit init_mode => {
...
modal_mixin [A * ModalEditor]
  ...
  trait [self : ModalEditor] inherits
    editor & retrieve & modal_edit init_mode => {};
--END_MODAL_MIXIN

--BEGIN_MODAL_USE
modal_editor = modal_mixin Top editor "command";
my_editor3 = new[ModalEditor] modal_editor
main = my_editor3.toggle_mode () -- Output: "toggle to insert!"
--END_MODAL_USE
